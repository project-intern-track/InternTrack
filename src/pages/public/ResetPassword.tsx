...
import { Briefcase, Lock, Eye, EyeOff, ArrowRight, Loader2, CheckCircle, AlertCircle } from 'lucide-react';
...
const ResetPassword = () => {
    ...
    const validateAll = (): boolean => {
        ...
        const pwErr = validateField('newPassword');
                        ...
                        <form onSubmit={handleSubmit} className="auth-form" id="reset-password-form" noValidate>
                            <div className="auth-field">
                                ...
                                {touched.newPassword && fieldErrors.newPassword && (
                                    <span className="auth-field-hint auth-field-hint-error" id="reset-password-error">
                            ...
                            <div className="auth-field">
                                ...
                                {touched.confirmPassword && fieldErrors.confirmPassword && (
                                    <span className="auth-field-hint auth-field-hint-error" id="reset-confirm-error">
