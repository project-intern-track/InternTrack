...
| Task | Status | Assigned |
|---|---|---|
| **1. Supervisor Dashboard** | ✅ Done | Jay + Victor |
| **2. Approve Tasks** | 🔶 Static UI Only | Jay + Victor Backend |
| &nbsp;&nbsp;&nbsp;&nbsp;a. To Be Reviewed | 🔶 Static UI Only | Jay + Victor Backend |
| &nbsp;&nbsp;&nbsp;&nbsp;b. Approved | 🔶 Static UI Only | Jay + Victor Backend |
| &nbsp;&nbsp;&nbsp;&nbsp;c. Rejected | 🔶 Static UI Only | Jay + Victor Backend |
| **3. Evaluations** | 🔶 Static UI Only | Jay + Victor Backend |
