                ...
                <table className="attendance-table-header">
                  <thead>
                    <tr>
                      ...
                      <th className="w-[15%]">TIME IN</th>
                      <th className="w-[15%]">TIME OUT</th>
                      <th className="w-[18%]">TOTAL HOURS</th>
                    ...
                    <tbody>
                      {paginatedRecords.map((record, index) => (
                        <tr key={`${record.id}-${record.date}-${index}`}>
                          ...
                          <td className="w-[12%]">{formatDate(record.date)}</td>
                          <td className="w-[15%]">{formatTime(record.time_in)}</td>
                          <td className="w-[15%]">{formatTime(record.time_out)}</td>
                          <td className="w-[18%]">{formatHours(record.total_hours)}</td>
