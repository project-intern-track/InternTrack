...
<head>
    ...
    <title>Verify Your Email - InternTrack</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px; color: #333333; line-height: 1.6;">
                            ...
                            <p style="margin: 0 0 20px; font-size: 16px;">
                                Thank you for signing up with <strong>InternTrack</strong>. To complete your registration and start managing your internship journey, please verify your email address.
                            </p>
                            ...
                            <table role="presentation" style="margin: 0 auto;">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="{{ $url }}"
                                           style="display: inline-block; padding: 16px 40px; background-color: #FF8800; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 600; letter-spacing: 0.5px;">
                            ...
                            <p style="margin: 0 0 20px; padding: 12px; background-color: #f8f8f8; border-radius: 4px; font-size: 13px; word-break: break-all; color: #555555;">
                                {{ $url }}
                            </p>
                    ...
                    <tr>
                        <td style="padding: 30px 40px; background-color: #f8f8f8; border-radius: 0 0 8px 8px; text-align: center; color: #888888; font-size: 13px; line-height: 1.5;">
                            <p style="margin: 0 0 10px;">
                                If you didn't create an account with InternTrack, you can safely ignore this email.
                            </p>
