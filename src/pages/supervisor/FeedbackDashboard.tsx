      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4">
        {[
          ...
          <motion.div
            ...
            className="rounded-[2rem] border border-gray-200 bg-white p-3 shadow-sm backdrop-blur-md md:p-6 dark:border-white/5 dark:bg-slate-900/50"
          >
            <div className={`mb-2 inline-flex rounded-lg px-2.5 py-1.5 md:mb-3 md:px-3 md:py-2 ${card.bg}`}>
      ...
      {competencyModal && createPortal(
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/50 px-4 py-6 backdrop-blur-sm">
          <motion.div
            ...
            className="relative max-h-full w-full max-w-2xl overflow-y-auto rounded-xl border border-gray-200 bg-white p-4 sm:p-8 shadow-xl dark:border-white/10 dark:bg-slate-900"
          >
            <button
